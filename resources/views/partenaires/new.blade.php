    ...
    <section class="content">
        <div class="box">
            <div class="box-header">
                <h3 class="box-title">Ajout de partenaire </h3>
            </div>
                        ...
                        <div class="container">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="form-group">
                                        <input id="phone" required name="phone" style="width: 258%;" type="tel" value=""/>
                                    </div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">  
                                        ...
                                        <input type="text" autocomplete="off" required class="form-control" name="num_rccm">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">  
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">  
                                        ...
                                        <input type="text" autocomplete="off" required class="form-control" name="num_ifu">
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">  
