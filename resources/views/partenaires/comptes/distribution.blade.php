        ...
        <div class="row">
            <div class="col-lg-12 col-xs-12">
                <div class="small-box bg-aqua">
                    <div class="inner">
                        <h3>{{ $compteDistribution->solde }} XOF</h3>
                        <p>Compte commission {{ $compteDistribution->partenaire->libelle }}</p>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-12 col-xs-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Mouvement du compte de distribution </h3>
                    </div>
