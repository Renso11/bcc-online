...
@endsection
@section('title')
    Rapport des transactions par partenaires
@endsection
@section('page')
    Rapport des transactions par partenaires
@endsection
            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Transactions par partenaire </h3>
                    </div>
                        ...
                        <form id="form-search">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control select2bs4" id="partenaire" multiple name="partenaires[]" style="width:100%">
...
@section('js')
    ...
    <script>
        ...
        $('#btn-search').on('click',function(e) {
            ...
            if(type_operation == "" || status == "" || partenaire == ""){
                toastr.warning("Veuillez renseigner le type d'operation ou le status ou le partenaire")
                $this.html(`<i class="fa fa-search"></i> Rechercher</button>`)
                $this.prop('disabled',false)
            }else{
                $.ajax({
                    url: "/search/transactions/partenaire",
                    data: formData,
                    processData: false,
                    contentType: false,
                    method: "post",
                    ...
                    success: function(data){
                        ...
                        $(".exportToExcel").click(function (e) {
                            ...
                            $($tableClone).table2excel({
                                exclude: ".noExl",
                                name: "Rapport des transactions des partenaires",
                                filename: "Rapport des transactions des partenaires.xls",
                                fileext: ".xls",
                                exclude_img: true,
                                exclude_links: true,
                                exclude_inputs: true,
