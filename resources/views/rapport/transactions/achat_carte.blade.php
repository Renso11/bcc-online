            ...
            <div class="col-12">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Achat de carte </h3>
                    </div>
                        ...
                        <form id="form-search">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-3">
                                    ...
                                    <select class="form-control select2bs4" id="nature" multiple name="promos[]" style="width:100%">
                                        <option value="all">Tous</option>
                    ...
                    success: function(data){
                        ...
                        $(".exportToExcel").click(function (e) {
                            ...
                            $($tableClone).table2excel({
                                exclude: ".noExl",
                                name: "Rapport des achats de cartes",
                                filename: "Rapport des achats de cartes.xls",
                                fileext: ".xls",
                                exclude_img: true,
                                exclude_links: true,
                                exclude_inputs: true,
