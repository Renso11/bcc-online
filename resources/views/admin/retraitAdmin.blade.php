...
@section('content')
    <section class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <button type="button" class="btn waves-effect waves-light btn-primary" data-toggle="modal" data-target="#add-retrait">Nouveau retrait</button>
                    <br>
                    <br>
                    <div class="box">
                        <div class="box-header">
                            <h3 class="box-title">Liste des retraits admin </h3>
                        </div>
        ...
        <div class="modal fade" id="add-retrait" role="dialog" aria-labelledby="exampleModalLabel1">
            <div class="modal-dialog" role="document">
                <form action="/retrait/admin/add" method="POST" enctype="multipart/form-data"> 
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control select2bs4" name="type" id="type">
                                            <option value="card">Retrait d'une carte</option>
                                            <option value="bmo">Retrait d'un bmo</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                ...
                                <div id="bmomo" style="display: none">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label for="">Numero du retrait</label>
                                            <input type="text" class="form-control" name="numero" placeholder="Numero retrait">
                                        </div>
                                    </div>
                                </div>
                            </div> 
